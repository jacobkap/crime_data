*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 33601
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2010: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\33601-0003-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da33601-0003.sav").
*
*-------------------------------------------------------------------------.
