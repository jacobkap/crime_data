*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 32562
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2009: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\12345-0003-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da12345-0003.sav").
*
*-------------------------------------------------------------------------.
