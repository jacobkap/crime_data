*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 04692
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2002: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\04692-0003-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da04692-0003.sav").
*
*-------------------------------------------------------------------------.
