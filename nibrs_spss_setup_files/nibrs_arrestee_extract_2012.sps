*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 35036
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2012: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\35036-0004-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da35036-0004.sav").
*
*-------------------------------------------------------------------------.
...
VALUE LABELS
   ...
   V1016     -6 'Not applicable' -5 'NA Window/Grp B Record'
             0 '* (Undocumented code)' 1 'No' 2 'Yes' /
   ...
   V6013     -6 'Not applicable' 1 'Unarmed' 110 'Firearm'
             ...
             151 'Other Firearm, automatic' 200 'Lethal Cutting Instrument'
             300 'Club/Blackjack/Brass Knuckles' /
   V6014     99 'Over 98 years old' -7 'Unknown/Missing/DNR'/
   ...
   V20201    -9 'Undetermined' -8 'NA LT 3 records' -7 'Unknown/Missing/DNR'
             ...
             13 'American Indian or Alaska Native' 14 'Asian'
             15 'Multi-Racial Group'
             16 'Native Hawaiian or Other Pacific Islander' 21 'Jewish'
             22 'Catholic' 23 'Protestant' 24 'Islamic (Moslem)'
             25 'Other Religion' 26 'Multi-Religious Group'
             27 'Atheism/Agnosticism' 32 'Hispanic or Latino'
             33 'Not Hispanic or Latino' 41 'Male Homosexual (Gay)'
             42 'Female Homosexual (Lesbian)'
             43 'Lesbian, Gay, Bisexual, or Trangender, Mixed Group (LGBT)'
             44 'Heterosexual' 45 'Bisexual' 51 'Physical Disability'
             52 'Mental Disability' 61 'Male' 62 'Female' 71 'Transgender'
             72 'Gender Non-Conforming' 88 'None' 99 'Unknown' /
