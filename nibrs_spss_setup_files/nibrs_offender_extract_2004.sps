*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 04485
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2004: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\04485-0003-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da04485-0003.sav").
*
*-------------------------------------------------------------------------.
