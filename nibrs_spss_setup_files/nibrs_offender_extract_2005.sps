*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 20303
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2005: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\20303-0003-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da20303-0003.sav").
*
*-------------------------------------------------------------------------.
