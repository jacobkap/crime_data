*-------------------------------------------------------------------------*
*                                                                          
*                     SPSS SETUP FILE FOR ICPSR 23541
*         NATIONAL INCIDENT-BASED REPORTING SYSTEM, 2006: EXTRACT
*                                  FILES
...
*  data file is physically located (e.g., "c:\temp\23541-0003-data.txt").
*
...
*  will be saved (e.g., SAVE OUTFILE="c:\spsswin\data\da23541-0003.sav").
*
*-------------------------------------------------------------------------.
