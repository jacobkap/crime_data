...
weapons <- c("^oth -type dk$"     = "other or unknown weapon",
             ...
             "^knife - cutting$"  = "lethal cutting instrument (knife, ice pick, screwdriver, ax, etc.)",
             "^personal weapons$" = "personal weapons (hands, feet, teeth, etc.)",
             "^narcotics drugs$"  = "drugs/narcotics/sleeping pills",
             ...
             "^blunt object - hammer, club, etc$"      = "blunt object (e.g., club/blackjack/brass knuckles)",
             "^blunt object$"      = "blunt object (e.g., club/blackjack/brass knuckles)",
             "^narcotics or drugs, sleeping pills$"    = "drugs/narcotics/sleeping pills",
             "^inap$"                  = NA,
             ...
             "^knfe/cttg instrmnt$"    = "lethal cutting instrument (knife, ice pick, screwdriver, ax, etc.)",
             ...
             "^knife-cut inst$"        = "lethal cutting instrument (knife, ice pick, screwdriver, ax, etc.)",
             "^strangulat -hang$"      = "strangulation - includes hanging",
             "^knife/cttg instrmt$"    = "lethal cutting instrument (knife, ice pick, screwdriver, ax, etc.)",
             "^strangulat -hang$"      = "strangulation - includes hanging",
             ...
             ".*inap.*"                = NA,
             "^knfe/cttg instrmt$"     = "lethal cutting instrument (knife, ice pick, screwdriver, ax, etc.)",
             ...
             "^personl weapons$"       = "personal weapons (hands, feet, teeth, etc.)",
             "^personal weapons, includes beating$" = "personal weapons (hands, feet, teeth, etc.)",
             "^blnt objct$"            = "blunt object (e.g., club/blackjack/brass knuckles)",
             "^strangulat-hang$"       = "strangulation - includes hanging",
             ...
             "^poison -not gas$"       = "poison - does not include gas",
             "^knfe/cttng instrmnt$"   = "lethal cutting instrument (knife, ice pick, screwdriver, ax, etc.)",
             "^other-wpn nt dsgntd$"   = "other or unknown weapon",
             "^other or type unknown$"   = "other or unknown weapon",
             "^other gun$"   = "other firearm"
             )


ethnic <- c("^not of hispanic origin$"  = "not hispanic or latino",
            "^hispanic origin$"         = "hispanic or latino",
            "^not hispanic or latino$"  = "not hispanic or latino",
            "^hispanic or latino$"      = "hispanic or latino",
            "^not of hispanic$"         = "not hispanic or latino",
            "^unknown-not rept$"        = "unknown",
            "^unknown or not reported$" = "unknown",
            "^not reported$"            = "unknown",
            "^unknown/not rpt$"         = "unknown",
            "^not of hisp orgn$"        = "not hispanic or latino",
            "^hisp origin$"             = "hispanic or latino",
            "^hispanic$"                = "hispanic or latino",
            "^not hispanic$"            = "not hispanic or latino",
            "^not of hisp origin$"      = "not hispanic or latino",
            ".*inap.*"                  = NA,
            "^not hisp orgn$"           = "not hispanic or latino",
...
race <- c("^white -chicano$"                   = "white",
         ...
         "^amer indi-eskimo$"                  = "american indian/alaskan native",
         ...
         "^amer ind/alask nat$"                = "american indian/alaskan native",
         "^asn/pacific islander$"              = "asian",
         "^amer ind/alsk nat$"                 = "american indian/alaskan native",
         "^ameri indi-eskimo$"                 = "american indian/alaskan native",
         ".*inap.*"                            = NA)

relationship <- c("^dk,all instances$"            = "relationship unknown",
                  "^homosexual relat$"            = "victim was in a homosexual relationship with the offender",
                  "^oth -known to vi$"            = "victim was otherwise known",
                  "^common-law husba$"            = "victim was common-law husband",
                  "^relationship not determined$" = "relationship unknown",
                  "^oth-vic knows$"               = "victim was otherwise known",
                  "^rel not determnd$"            = "relationship unknown",
                  "^common-law husb$"             = "victim was common-law husband",
                  "^rltnshp not dtrmnd$"          = "relationship unknown",
                  "^reltnshp nt dtrmnd$"          = "relationship unknown",
                  "^other - known-vctm$"          = "victim was otherwise known",
                  "^homosxl rltnshp$"             = "victim was in a homosexual relationship with the offender",
                  "^hmsxl rltnshp$"               = "victim was in a homosexual relationship with the offender",
                  "^other-known-vctm$"            = "victim was otherwise known",
                  "^othr-knwn-vctm$"              = "victim was otherwise known",
                  "^othr-knwn-vctm$"              = "victim was otherwise known",
                  "^other-knwn-vctm$"             = "victim was otherwise known",
                  "^acquaintance$"                = "victim was acquaintance",
                  "^boyfriend$"                   = "victim was boyfriend",
                  "^brother$"                     = "victim was brother",
                  "^common-law husband$"          = "victim was common-law husband",
                  "^common-law wife$"             = "victim was common-law wife",
                  "^daughter$"                    = "victim was daughter",
                  "^employee$"                    = "victim was employee",
                  "^employer$"                    = "victim was employer",
                  "^ex-husband$"                  = "victim was ex-husband",
                  "^ex-wife$"                     = "victim was ex-wife",
                  "^father$"                      = "victim was father",
                  "^friend$"                      = "victim was friend",
                  "^girlfriend$"                  = "victim was girlfriend",
                  "^homosexual relationship$"     = "victim was in a homosexual relationship with the offender",
                  "^husband$"                     = "victim was husband",
                  "^in-law$"                      = "victim was in-law",
                  "^mother$"                      = "victim was mother",
                  "^neighbor$"                    = "victim was neighbor",
                  "^other - known to victim$"     = "victim was otherwise known",
                  "^other family$"                = "victim was other family",
                  "^sister$"                      = "victim was sister",
                  "^son$"                         = "victim was son",
                  "^stepdaughter$"                = "victim was stepdaughter",
                  "^stepfather$"                  = "victim was stepfather",
                  "^stepmother$"                  = "victim was stepmother",
                  "^stepson$"                     = "victim was stepson",
                  "^stranger$"                    = "victim was stranger",
                  "^wife$"                        = "victim was wife",
                  ".*inap.*"                      = NA)
...
age <- c("^7 dys old-364 dys$"    = "between 6 days and 1 year old (baby)",
         "^7 dys old-364 days$"   = "between 6 days and 1 year old (baby)",
         "^7 days old to 364 days old$" = "between 6 days and 1 year old (baby)",
         "^brth-6 days old$"      = "1 to 6 days old (newborn)",
         "^birth to 6 days, including abandoned infant$"      = "1 to 6 days old (newborn)",
         "^99 yrs old/more$"      = "over 98 years old",
         "^birth to 1 yr ol$"     = "between 6 days and 1 year old (baby)",
         "^99 yrs old - mor$"     = "over 98 years old",
         "^99 years or more$"     = "over 98 years old",
         "^99 years old or more$" = "over 98 years old",
         "^99 years or older$" = "over 98 years old",
         "^1 year old$"           = "1",
         "^nb$"                   = "1 to 6 days old (newborn)",
         "^birth to 6 days old$"  = "1 to 6 days old (newborn)",
         "^out of universe$"      = NA,
         "^age unknown$"          = NA,
         ".*inap.*"               = NA,
         ".*inp.*"                = NA,
