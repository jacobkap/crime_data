...
This setup file was created using the R package asciiSetupReader(version 2.2.0) on 2019-12-07 22:16:06. For any feedback or problems (or if the file looks odd), please make a report on https://github.com/jacobkap/asciiSetupReader/issues. For more information on this package see here: https://jacobkap.github.io/asciiSetupReader/.
