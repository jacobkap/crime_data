...
This setup file was created using the R package asciiSetupReader(version 2.1.0) on 2019-07-28 15:55:22. For any feedback or problems (or if the file looks odd), please make a report on https://github.com/jacobkap/asciiSetupReader/issues. For more information on this package see here: https://jacobkap.github.io/asciiSetupReader/.
