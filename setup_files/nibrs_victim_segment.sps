...
This setup file was created using the R package asciiSetupReader(version 2.5.0) on 2022-10-05 23:34:38. For any feedback or problems (or if the file looks odd), please make a report on https://github.com/jacobkap/asciiSetupReader/issues. For more information on this package see here: https://jacobkap.github.io/asciiSetupReader/.
