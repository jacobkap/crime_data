setup_files/nibrs_arrestee_segment

This setup file was created using the R package asciiSetupReader(version 2.5.2) on 2025-08-10 02:22:28.0377. For any feedback or problems (or if the file looks odd), please make a report on https://github.com/jacobkap/asciiSetupReader/issues. For more information on this package see here: https://jacobkap.github.io/asciiSetupReader/.
