...
group_number <- c("cit\\. |cit |citie |^cts "            = "cities ",
                  ...
                  " cots | cts "     = " county ",
                  " udr | undr "     = " under ",
                  "al county mlln ovr" = "msa county 1,000,000+",
                  "^non-msa county 10,000$" = "non-msa county under 10,000",
                  "^msa county 10,0000/over$" = "msa county 100,000+"
)
